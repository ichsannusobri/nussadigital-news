...
export function getAuthorAvatar(authorName) {
  ...
  if (name === 'ichsan n' || name === 'ichsan nusobri') return '/authors/ichsan-n.png';
  if (name === 'filza syah') return '/authors/filza-syah.png';
  if (name === 'ndnews editorial team') return '/authors/editorial-team.png';
  if (name === 'ndnews sportteam') return '/authors/sport-team.png';
